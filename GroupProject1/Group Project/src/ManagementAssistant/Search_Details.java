...
public class Search_Details extends javax.swing.JFrame {
    ...
    public Search_Details(JFrame parent) {
        initComponents();
    ...
    private void initComponents() {
        ...
        cmbSearch.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Applicant", "Application" }));
        ...
        panMain.add(btnView, new org.netbeans.lib.awtextra.AbsoluteConstraints(662, 340, 80, -1));
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        ...
        if (cmbSearch.getSelectedIndex() == 0) { // applicant search
    ...
    private void btnViewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnViewActionPerformed
        if (table.getRowCount()>0) {
            if(cmbSearch.getSelectedIndex() == 0 && !tblResultsApplicant.getSelectionModel().isSelectionEmpty()) { // applicant
                String applicantNIC = tblResultsApplicant.getModel().getValueAt(tblResultsApplicant.getSelectedRow(), 2).toString();
                new View_Applicant(this, applicantNIC).setVisible(true);
                this.setState(1);
                ...
                new View_Application(this, applcationID).setVisible(true);
                this.setState(1);
            }
    ...
    private void cmbSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmbSearchActionPerformed
        ...
        table.fireTableDataChanged();
        btnView.setEnabled(false);
        if (cmbSearch.getSelectedIndex() == 0) { // applicant
            hideTables();
            pan_applicant.show();
            table = (DefaultTableModel) tblResultsApplicant.getModel();
    ...
    private void generateTable(String text, int method) {
        ...
        try {
            if (cmbSearch.getSelectedIndex() == 0) { // generate applicant table
    ...
    public static void main(String args[]) {
        ...
        SwingUtilities.invokeLater(new Runnable() {
            ...
            public void run() {
                ...
                new Search_Details(null).setVisible(true);
            }
        });
    }
