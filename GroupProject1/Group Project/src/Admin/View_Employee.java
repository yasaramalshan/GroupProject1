...
public class View_Employee extends javax.swing.JFrame {
    ...
    public View_Employee(JFrame parent,String empID) {//JFrame parent
        initComponents();
        this.parent = parent;
        dataAdder(empID);
    ...
    private void initComponents() {
        ...
        pan2.add(btnClose, new org.netbeans.lib.awtextra.AbsoluteConstraints(535, 280, 78, -1));
        ...
        pan2.add(txtDesignation, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 50, 325, -1));
        pan2.add(txtGender, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 110, 160, -1));
    ...
    private void dataAdder(String empID) {
        ...
        try {
            ...
            System.out.println("exeption in dataAdder method in ViewEmployee "+e);
        }
    }
    ...
    public static void main(String args[]) {
        ...
        SwingUtilities.invokeLater(new Runnable() {
            ...
            public void run() {
                ...
                new View_Employee(null,null).setVisible(true);
            }
        });
    }
