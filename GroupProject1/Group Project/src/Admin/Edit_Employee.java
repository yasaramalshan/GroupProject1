...
public class Edit_Employee extends javax.swing.JFrame {
    ...
    public Edit_Employee(JFrame parent,String empID) {//JFrame parent
        initComponents();
        dataAdder("101234");
        this.parent = parent;
    ...
    private void initComponents() {
        ...
        scrAddress.setViewportView(txtAreaAddress);
        ...
        pan2.add(btnUpdate, new org.netbeans.lib.awtextra.AbsoluteConstraints(535, 280, 78, -1));
        ...
        pan2.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(42, 160, 290, -1));

        jLabel14.setFont(new java.awt.Font("Segoe UI", 0, 12)); // NOI18N
        jLabel14.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel14.setText("Allocated Wards ");
        pan2.add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 195, 141, -1));

        jLabel29.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        jLabel29.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel29.setText(":");
        pan2.add(jLabel29, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 195, 23, -1));

        txtWards.setEditable(false);
        pan2.add(txtWards, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 195, 325, -1));

        jLabel3.setFont(new java.awt.Font("Tahoma", 2, 10)); // NOI18N
        jLabel3.setText("Separate By '/'");
        pan2.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(475, 230, 70, -1));

        jSeparator1.setForeground(new java.awt.Color(102, 102, 102));
        pan2.add(jSeparator1, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 175, 533, 10));
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        if (!emp.getEmail().equals("") && !Extra.isValidEmail(emp.getEmail())) {
            ...
            if (new DBOperations().updateEmployee(emp)) {
                JOptionPane.showMessageDialog(this, "Employee Update Successfull...!", "Update Succeed", JOptionPane.INFORMATION_MESSAGE, new ImageIcon(getClass().getResource("Images/message_success.png")));
                this.dispose();
                parent.setState(0);
            } else {
                JOptionPane.showMessageDialog(this, "Update Failed..!", "Error", JOptionPane.ERROR_MESSAGE, new ImageIcon(getClass().getResource("Images/message_error.png")));
            }
        }
    ...
    private void btnNextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNextActionPerformed
        ...
        emp.setAddress(Extra.capitalizer(txtAreaAddress.getText()));
    ...
    private void dataAdder(String empID) {
        ResultSet rs = new DBOperations().getEmployee(empID, 3);
        try {
            rs.next();
            txtUserID.setText(rs.getString("employee_id"));
            ...
            txtTelNo.setText(rs.getString("contact_no"));
            txtEmail.setText(rs.getString("email"));
            cmbDesignation.setSelectedItem(rs.getString("designation"));
            txtGovRegNo.setText(rs.getString("gov_reg_no"));
            if (rs.getString("gender").equalsIgnoreCase("Male")) {
                rbtnIsMale.setSelected(true);
            } else {
                rbtnIsFemale.setSelected(true);
            }

            txtWards.setText(rs.getString("allocated_wards").substring(0, rs.getString("allocated_wards").length()-1));
        } catch (Exception e) {
            System.out.println("exeption in dataAdder method in EditEmployee "+e);
        }
    }
    ...
    public static void main(String args[]) {
        ...
        SwingUtilities.invokeLater(new Runnable() {
            ...
            public void run() {
                ...
                new Edit_Employee(null,null).setVisible(true);
            }
        });
    }
