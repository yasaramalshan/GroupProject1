 ...
 * @author Yasara JLP
 */
public class View_Details_admin extends javax.swing.JFrame {
    ...
    public View_Details_admin(JFrame parent) {
        initComponents();
    ...
    private void initComponents() {
        ...
        setUndecorated(true);
        setPreferredSize(new java.awt.Dimension(750, 372));
        setResizable(false);
    ...
    private void btnViewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnViewActionPerformed
        if (table.getRowCount()>0) {
            if (cmbSearch.getSelectedIndex() == 0 && !tblResultsEmployee.getSelectionModel().isSelectionEmpty()) { // employee
                ...
                new View_Employee(this, userID).setVisible(true);
                this.setState(1);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(View_Details_admin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        SwingUtilities.invokeLater(new Runnable() {
            ...
            public void run() {
                ...
                new View_Details_admin(null).setVisible(true);
            }
        });
    }
