 ...
 * @author Yasara JLP
 */
public class Reset_User_Pass extends javax.swing.JFrame {
    ...
    public Reset_User_Pass(JFrame parent) {
        initComponents();
        ...
        tblResults.setShowHorizontalLines(true);//hide horizontal lines from grid
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Reset Passwords");
        ...
        btnReset.setActionCommand("Search");
        ...
        panMain.add(btnReset, new org.netbeans.lib.awtextra.AbsoluteConstraints(544, 343, 78, -1));
    ...
    private void btnResetMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnResetMouseEntered
        setButtonColour(btnReset);
    }//GEN-LAST:event_btnResetMouseEntered

    private void btnResetMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnResetMouseExited
        resetButtonColour(btnReset);
    }//GEN-LAST:event_btnResetMouseExited

    private void btnResetActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnResetActionPerformed
        try {
            String userID = tblResults.getModel().getValueAt(tblResults.getSelectedRow(), 0).toString().trim();
            ...
            if (dialogResult == JOptionPane.YES_OPTION) {
                if (new DBOperations().resetEmployeePass(userID)) {
                    JOptionPane.showMessageDialog(this, "Password Reset Successfull...!", "Reset Succeed", JOptionPane.INFORMATION_MESSAGE, new ImageIcon(getClass().getResource("Images/message_success.png")));
                    this.dispose();
                    parent.setState(0);
                } else {
                    JOptionPane.showMessageDialog(this, "Password Reset Failed..!", "Error", JOptionPane.ERROR_MESSAGE, new ImageIcon(getClass().getResource("Images/message_error.png")));
                }
            }
        } catch (Exception e) {
            System.out.println("Exeption in btnResetActionPerformed method " + e);
        } finally {
            try {
                if (rs != null) {
                    rs.close();
                ...
                System.out.println("final in btnResetActionPerformed method final" + ex);
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Reset_User_Pass.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        SwingUtilities.invokeLater(new Runnable() {
            ...
            public void run() {
                ...
                new Reset_User_Pass(null).setVisible(true);
            }
        });
    }
