 ...
 * @author Yasara JLP
 */
public class Edit_Applicant extends javax.swing.JFrame {

    Applicant applicant = new Applicant();
    private int xMouse, yMouse;
    JFrame parent;

    public Edit_Applicant(JFrame parent, String nic) { // JFrame parent
        initComponents();
        this.parent = parent;
        dataAdder(nic);
    ...
    private void initComponents() {
        ...
        jPanel1.add(btnUpdate, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 280, 78, -1));
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        if (applicant.getFirstName().equals("")) {
            ...
            if (dbops.updateApplicant(applicant)) {
                JOptionPane.showMessageDialog(this, "Update Successfull...!", "Register Succeed", JOptionPane.INFORMATION_MESSAGE, new ImageIcon(getClass().getResource("Images/message_success.png")));
                this.dispose();
                parent.setState(0);
            } else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Edit_Applicant.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        SwingUtilities.invokeLater(new Runnable() {
            ...
            public void run() {
                ...
                new Edit_Applicant(null, null).setVisible(true);
            }
        });
    }
